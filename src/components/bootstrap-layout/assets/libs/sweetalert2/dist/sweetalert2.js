...
var lockBodyScroll = function lockBodyScroll() {
  ...
  getContainer().ontouchstart = function (e) {
    preventTouchMove = e.target === getContainer() || !isScrollable(getContainer());
  };

  getContainer().ontouchmove = function (e) {
    if (preventTouchMove) {
      e.preventDefault();
      e.stopPropagation();
    }
